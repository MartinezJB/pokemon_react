...
export default function EnemyDisplay({ enemy }) {
    ...
    return (
        <div className="relative flex flex-row-reverse top-3 items-start justify-between h-2/5">
            ...
            {/* Info */}
            <div className="w-6/12 md:w-5/12 lg:w-3/12 bg-stone-500 px-2 py-1 border-slate-800 border-2 rounded-r-lg shadow-border shadow-stone-300 lg:absolute lg:top-0 lg:right-0 lg:rounded-none lg:rounded-l-lg">
                ...
                <div className="flex justify-end items-center">
                    ...
                    <progress className="w-7/12 sm:w-8/12 md:w-9/12 h-3 border-slate-800 border-2 rounded" id="enemyHealt" min="0" max={max_life} value={actual_life}></progress>
                </div>
            </div>
